...
Free static space is only `.5`–`.7`, `.13`, `.29`, `.30`, `.32`–`.35`, `.38`, `.39`, `.50`.
...
| dev-workers (`dev-worker-6`/.13/4206 retired 2026-09-2x; dw3 retires next, then `dev-worker-1..4` on .8–.11) | .8–.12 (user `c4`; also the agentforge hosts, ADR 0018) | 4201–4205 |
