...
# GPU cluster; .14-.19/.23 answered ping). vmids: 43xx band (dev workers 42xx, runners
# 41xx, Talos 40xx, env pool 44xx).
variable "reviewer_nodes" {
  ...
  default = {
    "reviewer-1" = { node_name = "ai-node3", vm_id = 4301, ip = "192.168.0.24", hostname = "reviewer-1" }
    "reviewer-2" = { node_name = "ai-node3", vm_id = 4302, ip = "192.168.0.25", hostname = "reviewer-2" }
  }
}
