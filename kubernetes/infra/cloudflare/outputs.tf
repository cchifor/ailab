...
output "api_access_client_id" {
  description = "CF-Access-Client-Id header value for api.chifor.me callers."
  value       = cloudflare_zero_trust_access_service_token.api.client_id
  sensitive   = true
}

output "api_access_client_secret" {
  description = "CF-Access-Client-Secret header value for api.chifor.me callers (store where the client runs)."
  value       = cloudflare_zero_trust_access_service_token.api.client_secret
  sensitive   = true
}
